...
export function FacebookIcon({ size = 24, className = "" }) {
    return (
        <svg
            ...
            aria-hidden="true"
        >
            <path d="M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07C0 18.1 4.39 23.09 10.13 24v-8.44H7.08v-3.49h3.05V9.41c0-3.03 1.79-4.7 4.54-4.7 1.31 0 2.68.24 2.68.24v2.97h-1.51c-1.49 0-1.95.93-1.95 1.88v2.26h3.31l-.53 3.49h-2.78V24C19.61 23.09 24 18.1 24 12.07z" />
        </svg>
    );
}
